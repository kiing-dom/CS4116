...
<body>
   ...
   session_start();
        ...
        if(empty($_SESSION['loggedin'])){ header("location: adminLogin.php");} //if user not logged in, send to login
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="adminHome.php"><img class="img-fluid" id ="wavelength" src="images/sound.png"></img></a>
